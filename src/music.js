...
import "./music.css";
import withyou from "./audio/WithYou.mp3";
import cover1 from "./img/withyou.jpg";
import perfect from "./img/perfect.jpeg";
import ira from "./img/iraaday.jpeg";
import Pefect from "./audio/Perfect.mp3";
import iraa from "./audio/Iraaday.mp3";
import ninni from "./audio/Monna.mp3";
import nin from "./img/surya.jpeg";
  ...
  return (
    <>
      <div class="main">
        ...
        {songs.map((song) => (
          <div class="loader" key={song.id}>
            <div class="song">
              <p class="name" onClick={() => handleSongClick(song)}>
                {song.name}
              </p>
            ...
            {currentSong !== null && currentSong.name === song.name && (
              <div className={`loading`}>
                {console.log("inside the log", currentSong)}
                <div class="load"></div>
                <div class="load"></div>
                <div class="load"></div>
                <div class="load"></div>
